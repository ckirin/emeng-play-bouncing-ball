...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.sprites = []
        for ii in range(1,30):#your anime frame count
            imagframestr = './player/'+'%03d' % ii+'.tif'
            self.sprites.append(pygame.image.load(imagframestr))
        self.width_size = 160
        self.height_size = 80
        self.current_sprite = 0
        for ii in range(0,29):#your anime frame count
            self.image = pygame.transform.scale(self.sprites[ii],(self.width_size, self.height_size))
            self.sprites[ii] = pygame.transform.scale(self.sprites[ii],(self.width_size, self.height_size))	 
        self.rect = self.image.get_rect()
        self.rect.center =(WIDTH/2, self.height_size/2)
        self.x_speed = 0
        self.x_stop= 0 
        self.left_speed = -4
        self.right_speed = 4 
...
class Power_up(pygame.sprite.Sprite):
    def __init__(self, player):
        ...
        self.y_speed = (-1*random.randrange(1,3))
...
class Ball(pygame.sprite.Sprite):
    ...
    def update(self):
        ...
        if self.y_direction == "up" and self.rect.colliderect (player.rect):
            #self.image.fill(red)
